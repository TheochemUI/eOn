#ifndef GPRNUDGEDELASTICBANDAIE_H_
#define GPRNUDGEDELASTICBANDAIE_H_
...
class GPRNudgedElasticBandAIE : public NudgedElasticBand {
...
#endif // GPRNUDGEDELASTICBANDAIE_H_
