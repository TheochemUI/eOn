...
// // JobVariant mkJob(const toml::table tbl &tbl, Matter &mat) {
// //     JobVariant ret;
...
// //     break;
// //   }
// //   if (std::holds_alternative<PointJob>(ret))
...
// //     //     return
// (std::make_unique<ParallelReplicaJob>(std::move(params)));
// //     //     break;
// //     //   }
...
// //     //     return
// (std::make_unique<ReplicaExchangeJob>(std::move(params)));
// //     //     break;
// //     //   }
...
// //     //     return
// (std::make_unique<FiniteDifferenceJob>(std::move(params)));
// //     //     break;
// //     //   }
