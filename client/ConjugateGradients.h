...
public:
    ...
    bool isItConverged(double convergeCriterion);///< Determine if the norm of the force vector is below the \a convergeCriterion.
...
private:
    ...
    double *tempListDouble_;///< Double array with size equal to the number of atoms times 3.
    double *direction_;///< Double array with size equal to the number of atoms times 3.
    double *directionOld_;///< Double array with size equal to the number of atoms times 3.
    double *directionNorm_;///< Double array with size equal to the number of atoms times 3.
    double *force_;///< Double array with size equal to the number of atoms times 3.
    double *forceOld_; ///< Double array with size equal to the number of atoms times 3.
