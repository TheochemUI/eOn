...
public:
  ...
  // Returns index of specified value, in the specified key, or noID if not
  // found.
  ...
  std::string ValueName(std::string const keyname,
                        unsigned const valueID) const;
  std::string GetValueName(std::string const keyname,
                           unsigned const valueID) const {
  ...
  long GetValueL(std::string const keyname, std::string const valuename,
                 long const defValue = 0) const;
  ...
  unsigned GetValueV(std::string const keyname, std::string const valuename,
                     char *format, void *v1 = 0, void *v2 = 0, void *v3 = 0,
                     void *v4 = 0, void *v5 = 0, void *v6 = 0, void *v7 = 0,
                     void *v8 = 0, void *v9 = 0, void *v10 = 0, void *v11 = 0,
                     void *v12 = 0, void *v13 = 0, void *v14 = 0, void *v15 = 0,
                     void *v16 = 0);
  ...
  bool SetValue(std::string const keyname, std::string const valuename,
                std::string const value, bool const create = true);
  bool SetValueI(std::string const keyname, std::string const valuename,
                 int const value, bool const create = true);
  bool SetValueB(std::string const keyname, std::string const valuename,
                 bool const value, bool const create = true) {
    return SetValueI(keyname, valuename, int(value), create);
  }
  bool SetValueF(std::string const keyname, std::string const valuename,
                 double const value, bool const create = true);
  bool SetValueV(std::string const keyname, std::string const valuename,
                 char *format, ...);
  ...
  std::string KeyComment(std::string const keyname,
