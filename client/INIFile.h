...
public:
  ...
  string GetValue(string const keyname, string const valuename,
                  string const defValue = "") const;
  string GetValue(string const keyname, string const valuename,
                  bool &found) const;
  int GetValueI(string const keyname, string const valuename,
                int const defValue = 0) const;
  long GetValueL(string const keyname, string const valuename,
                 long const defValue = 0) const;
  bool GetValueB(string const keyname, string const valuename,
                 bool const defValue = false) const;
  double GetValueF(string const keyname, string const valuename,
  ...
  unsigned GetValueV(string const keyname, string const valuename, char *format,
                     ...
                     void *v13 = 0, void *v14 = 0, void *v15 = 0,
                     void *v16 = 0);
  ...
  bool SetValue(unsigned const keyID, unsigned const valueID,
                string const value);
  bool SetValue(string const keyname, string const valuename,
                string const value, bool const create = true);
  bool SetValueI(string const keyname, string const valuename, int const value,
                 bool const create = true);
  bool SetValueB(string const keyname, string const valuename, bool const value,
                 bool const create = true) {
    return SetValueI(keyname, valuename, int(value), create);
  }
  bool SetValueF(string const keyname, string const valuename,
