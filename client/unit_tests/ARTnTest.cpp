...
protected:
  ...
  ARTnVsDimerFixture()
    ...
    ParametersLoadAccess::artn_options(params).push_step_size = 0.3;
    ParametersLoadAccess::artn_options(params).force_threshold = 0.05;
    ParametersLoadAccess::artn_options(params).max_iterations = 500;
  }
};
