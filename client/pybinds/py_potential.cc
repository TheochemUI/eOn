...
void py_potential(py::module_ &m){
  py::class_<Potential, PyPotential>(m, "Potential")
      ...
      ** Functions
      ...
      .def("force", py::overload_cast<
           long /*nAtoms*/, AtomMatrix /*positions*/,
           VectorXi /*atomicNrs*/, double* /*energy*/,
           Matrix3d /*box*/, int /*nImages*/
           >(&Potential::force), "Get forces",
           py::arg("nAtoms"), py::arg("positions"),
           py::arg("atomicNrs"), py::arg("energy"),
           py::arg("box"), py::arg("nImages")
      )
      .def("force", py::overload_cast<long /*nAtoms*/,
           ...
           double* /*energy*/,
           const double* /*box*/,
           int /*nImages*/>(&Potential::force), "Get forces",
           py::arg("nAtoms"),
           py::arg("positions"), py::arg("atomicNrs"),
           py::arg("forces"), py::arg("energy"),
           py::arg("box"), py::arg("nImages")
           )
...
#ifndef WIN32
#ifdef WITH_VASP
      .def_property_readonly_static("POT_VASP",
...
#endif
#ifdef EONMPI
      .def_property_readonly_static("POT_MPI",
...
#ifdef WITH_PYTHON
 #ifdef PYAMFF_POT
      .def_property_readonly_static("POT_PYAMFF",
                           [](py::object /*self*/){return Potential::POT_PYAMFF;},
                           "PYAMFF potential string"
                           )
 #endif
      .def_property_readonly_static("POT_QSC",
...
#ifdef WITH_AMS
      .def_property_readonly_static("POT_AMS",
                           [](py::object /*self*/){return Potential::POT_AMS;},
                           "AMS potential string"
                           )
      .def_property_readonly_static("POT_AMS_IO",
