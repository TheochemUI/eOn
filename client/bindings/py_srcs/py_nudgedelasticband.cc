...
template<> struct type_caster<std::vector<Matter *>> : ListCasterBase {
...
void py_nudgedelasticband(py::module_ &m) {
    py::class_<NudgedElasticBand>(m, "NudgedElasticBand")
        ...
        */
        ...
        .def_property("neb_images",[](const NudgedElasticBand *neb)->std::reference_wrapper<std::vector<Matter *>>{
                        // TODO: Does this leak?
