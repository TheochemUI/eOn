...
std::vector<std::string> ProcessSearchJob::run(void)
{
    ...
    if (params->saddleMethod == "min_mode" || params->saddleMethod == "basin_hopping" || params->saddleMethod == "bgsd") {
...
int ProcessSearchJob::doProcessSearch(void)
{
    ...
    *min1 = *saddle;
    ...
    displacedPos = posSaddle - saddleSearch->getEigenvector() * params->processSearchMinimizationOffset;
