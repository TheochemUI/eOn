...
// array where number of elements should corresponds to EMT_NumType
// the value of element [0] correspond to the atomic number of the atoms of the first type
// the value of element [1] correspond to the atomic number of the atoms of the second type
// and so on
// the last type is the type of atoms that eventually will be deposited!
