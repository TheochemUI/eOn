...
void lammps_open_no_mpi(int argc, char **argv, void **ptr)
{
  ...
  int noOutputArgc = 3;
  char **noOutput = new char*[3];
  noOutput[0] = (char*) "0";
  noOutput[1] = (char*) "-screen";
  noOutput[2] = (char*) "none";

  LAMMPS *lmp = new LAMMPS(noOutputArgc, noOutput, communicator);
...
void lammps_get_forces(void *ptr, double *forces)
{
  LAMMPS *lmp = (LAMMPS *) ptr;
  ...
  MPI_Allreduce(copy,forces,3*natoms,MPI_DOUBLE,MPI_SUM,lmp->world);
  delete [] copy;
}
