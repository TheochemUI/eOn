...
// General Functions
void LJCluster::setParameters(double u0Recieved, double cuttOffRRecieved, double psiRecieved){
    u0 = u0Recieved;
    psi = psiRecieved;
...
std::pair<double, AtomMatrix> LJCluster::get_ef(const AtomMatrix pos,
