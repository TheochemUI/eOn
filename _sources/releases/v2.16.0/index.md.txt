...
myst:
  html_meta:
    "description": "eOn v2.16.0: in-process rgpot potential (NWChem/CPMD), Davidson min-mode solver, readcon 0.13 ConFileIO rework, Metatomic output controls, PbcConvention."
...
This release adds the in-process **RgpotPot** potential (NWChem / CPMD through
