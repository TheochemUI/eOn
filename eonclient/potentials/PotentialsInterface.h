...
public:
    ...
    void virtual cleanMemory() = 0;///< One should implement the method cleanMemory instead a destructor as the desctructor call cause troubles when linking towards the potential libraries
