...
void solve_double(int, double *, int, double *, double *, double *, double *,
                  double *);
void solve_double_double(int, double *, int, double *, double *, double *,
                         double *, double *);
void solve_quad_double(int, double *, int, double *, double *, double *,
                       double *, double *);
...
template <class T>
void solve_general(int Qsize, double *Qflat, int Rcols, double *Rflat,
