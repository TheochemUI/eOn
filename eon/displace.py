...
class Displace:
    def __init__(
        self, reactant, std_dev, radius, hole_epicenters, config: ConfigClass = None
    ):
        if config is None:
...
class Undercoordinated(Displace):
    ...
    def init(self):
        ...
        self.undercoordinated_atoms = [
            ...
            if cns[i] <= self.max_coordination and self.reactant.atom_is_free()[i]
        ]
...
class Leastcoordinated(Displace):
    def __init__(
        ...
        self.leastcoordinated_atoms = [
            i for i in self.leastcoordinated_atoms if self.reactant.atom_is_free()[i]
        ]
...
class Random(Displace):
    def __init__(
        ...
        # each item in this list is the index of a free atom
        self.free_atoms = [
            i for i in range(len(self.reactant.free)) if self.reactant.atom_is_free()[i]
        ]
...
class NotFCCorHCP(Displace):
    def __init__(
        ...
        self.not_HCP_or_FCC_atoms = [
            i for i in self.not_HCP_or_FCC_atoms if self.reactant.atom_is_free()[i]
        ]
...
class NotTCPorBCC(Displace):
    def __init__(
        ...
        self.not_TCP_or_BCC_atoms = [
            i for i in self.not_TCP_or_BCC_atoms if self.reactant.atom_is_free()[i]
        ]
...
class NotTCP(Displace):
    def __init__(
        ...
        self.not_TCP_atoms = [
            i for i in self.not_TCP_atoms if self.reactant.atom_is_free()[i]
        ]
