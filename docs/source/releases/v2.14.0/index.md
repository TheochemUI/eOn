...
myst:
  html_meta:
    "description": "eOn v2.14.0: structured per-iteration metadata in .con movies via readcon-core, ARTn filin exposure, batched parallel force evaluation for NEB, and threading fixes for legacy Fortran potentials."
...
evaluation can batch potential calls across images instead of
