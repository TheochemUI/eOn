...
myst:
  html_meta:
    "description": "eOn v2.12.0: quill logging, namespace eonc, PotRegistry, SafeMath, and FPE hardening."
...
Also included: FPE hardening across the codebase, metatomic ecosystem
