...
typedef struct {
  ...
  double * d;
  double * sd;
} gsl_eigen_triag_workspace;

gsl_eigen_triag_workspace * gsl_eigen_triag_alloc (const size_t n);
void gsl_eigen_triag_free (gsl_eigen_triag_workspace * w);
int gsl_eigen_triag (const gsl_vector * diag, const gsl_vector * sub_diag, gsl_vector * eval, gsl_eigen_triag_workspace * w);
...
gsl_eigen_tridiagv_workspace * gsl_eigen_tridiagv_alloc (const size_t n);
void gsl_eigen_tridiagv_free (gsl_eigen_tridiagv_workspace * w);
int gsl_eigen_tridiagv (const gsl_vector * diag, const gsl_vector * sub_diag, gsl_vector * eval, gsl_matrix * evec, gsl_eigen_tridiagv_workspace * w);
